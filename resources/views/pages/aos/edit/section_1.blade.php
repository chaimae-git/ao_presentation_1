<section class="section_1 form-step form-step-active" id="section_1">
    <div class="row mb-3">
        <div class="form-group col">
            ...
            <input type="text" class="form-control" name="n_ao" placeholder="Numéro Ao" value={{old('n_ao', $ao->num_AO)}}>
    ...
    <div class="row mb-3">
        <div class="form-group col">
            ...
            <select name="type_id" class="form-control">
                ...
                @foreach($types as $type)
                    <option value="{{$type->id}}" @if((old('type_id')) && old('type_id') == $type->id) {{'selected'}} @elseif(($ao->type_id) && $ao->type_id == $type->id){{'selected'}} @endif>{{$type->type}}</option>
                @endforeach
            </select>
        ...
        <div class="form-group col">
            ...
            <input type="date" class="form-control" name="date_adjudication" placeholder="date_adjudication" value={{old('date_adjudication', $ao->date_adjiducation)}}>
    ...
    <div class="row mb-3">
        ...
        <div class="form-group col">
            ...
            <input type="text" class="form-control" name="n_lot" placeholder="nombre de lotissement" value={{old('n_lot', $ao->n_lot)}}>
        ...
        <div class="form-group col">
            ...
            <select name="client_id" class="form-control">
                ...
                @foreach($clients as $client)
                    <option value="{{$client->id}}" @if((old('client_id')) && old('client_id') == $client->id) {{'selected'}} @elseif(($ao->client_id) && $ao->client_id == $client->id){{'selected'}} @endif>{{$client->client}}</option>
                @endforeach
            </select>
    ...
    <div class="row mb-3">
        ...
        <div class="form-group col-4">
            ...
            <input type="text" class="form-control" name="montant_c_p" placeholder="montant caution provisoire" value={{old('montant_c_p', $ao->montant_c_p)}}>
        ...
        <div class="form-group col">
            ...
            <select name="critere_selection_id" class="form-control">
                ...
                @foreach($criteres_selections as $critere)
                    <option value="{{$critere->id}}" @if((old('critere_selection_id')) && old('critere_selection_id') == $critere->id) {{'selected'}}@elseif(($ao->critere_selection_id) && $ao->critere_selection_id == $critere->id){{'selected'}} @endif>{{$critere->critere}}</option>
                @endforeach
            </select>
